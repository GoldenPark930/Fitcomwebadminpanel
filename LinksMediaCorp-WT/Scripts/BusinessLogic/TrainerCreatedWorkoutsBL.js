   ...
   // $("#myLoadingElement").show();
    ...
    jQuery(function () {
        jQuery('#ChallengeSubTypeId').on("change", function () {          
            ...
            if (id === "15") {
                $('#FFchallegeCategoryHeader').text("Step 2 - Select Your Trending Category:");
                $('#FreeFormWorkoutDescriptionHeaderSection').text("Step 2 - Describe Your Challenge");
                $('#FreeFormChallengeExeciseSectionHeader').text("Step 3 - Choose Exercise(s):");
                $('#TrainerStepChallengeName').text("Step 4 - Enter Challenge Name:");
                ...
                $('#FFchallegeCategoryHeader').text("Step 2 - Select Your Trending Category:");
                $('#FreeFormWorkoutDescriptionHeaderSection').text("Step 3 - Describe Your Challenge");
                $('#FreeFormChallengeExeciseSectionHeader').text("Step 4 - Choose Exercise(s):");
                $('#TrainerStepChallengeName').text("Step 5 - Enter Challenge Name:");
                $('#divChallengeCategorySection').show();
                $('#FreeFormChallegeDescriptionHeaderSection').show();
                $('#divChallengeCategorySection').show();
                $('#FreeFormChallengeExeciseSection').show();
                $('#TrainerCreatedChallengeName').show();
                }          
