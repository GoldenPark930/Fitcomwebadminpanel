var TotalFilterChallengeRecords = new Array();
...
function validateTotalTrendingCategory()
{  
    var postedWorkoutTrendingCategoryCount = jQuery("#detailschkAssignWorkoutTrendingCategory [id*=PostedWorkoutTrendingCategory_TrendingCategoryID]:checked").length;
    var postedFitnnessTrendingCategoryCount = jQuery("#detailschkAssignFitnessTestTrendingCategory [id*=PostedFitnessTestTrendingCategory_TrendingCategoryID]:checked").length;
    var postedProgramtTrendingCategoryCount = jQuery("#detailschkAssignProgramTrendingCategory [id*=PostedProgramTrendingCategory_TrendingCategoryID]:checked").length;
    var total = parseInt(postedWorkoutTrendingCategoryCount) + parseInt(postedFitnnessTrendingCategoryCount) + parseInt(postedProgramtTrendingCategoryCount);       
    return total;
}
...
jQuery(document).delegate("input:text[id^='FitnessTest']", "focusin", function () {    
    ...
    jQuery(this).autocomplete({
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    jQuery.each(data, function (i, fitnessTest) {
                        ...
                        TotalFilterChallengeRecords.push(fitnessTestrecord);

                    });
                }
            });
            response($.map(TotalFilterChallengeRecords, function (item) {
                return {
        ...
        change: function (event, ui) {
            ...
            if (!ui.item) {
                this.value = '';
                jQuery("#SpnFitnessTestLink" + id).html("");
                if (!ui.item) {
                    $(fitcomtestChallengeId).val(0);
                }
                this.focus();
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    jQuery.each(data, function (i, fitnessTest) {
                        ...
                        TotalFilterChallengeRecords.push(beginnerProgramrecord);
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    jQuery.each(data, function (i, fitnessTest) {
                        ...
                        TotalFilterChallengeRecords.push(advIntProgramrecord);
                    });
                }
            });
            response($.map(TotalFilterChallengeRecords, function (item) {
...
$(document).on("click", "#AddLevel1Team", function () {    
...
$(document).on("click", "#AddLevel2Team", function () {   
