...
$(document).ready(function () {
    ...
    jQuery(function () {
        ...
        $('#FittnessTrendingTrendingCategoryHeader').text("Step 12 - Select Your Trending Category: ");
        $('#AdminStepNoTrainerTeam').text("Step 11 - Choose Teams to Assigned:");
        ...
        if (challengeSubtypeId != "") {
            ...
            if (challengeSubtypeId === "14") {              
               ...
               //Do Nothing
                ...
                if (selectedTrainerId > 0) {
                    $('#challengeNoTrainerTeam').hide();
                    $('#FittnessTrendingTrendingCategoryHeader').text("Step 11 - Select Your Trending Category:");
                    $('#AdminStepNoTrainerTeam').text("Step 11 - Choose Teams to Assigned:");
                }
                else {                   
                    $('#challengeNoTrainerTeam').show();
    ...
    jQuery(function () {
        if ($("#SelectAllFittnestTrendingCategory").is(':checked')) {
            $('#chkAllFittnestTrendingCategory [id*=PostedTrendingCategory_TrendingCategoryID]').each(function () {
                this.checked = true;
            });
        }
